...
// ================================================================
// SafeMath - Solidity 0.5.x 的溢出保护库
// ================================================================
library SafeMath {
...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function _mintFee(uint112 _reserve0, uint112 _reserve1) private returns (bool feeOn) {
        ...
        if (feeOn) {
            if (_kLast != 0) {
                uint rootK = Math.sqrt(uint(_reserve0).mul(uint(_reserve1)));
...
// 为 uint 类型附加 SafeMath 方法
// （这是 Solidity 0.5.x 的 using...for 语法）
