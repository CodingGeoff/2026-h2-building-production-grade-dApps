...
import { UniswapV2Factory } from "../typechain-types/contracts/UniswapV2Factory";
import { UniswapV2Pair } from "../typechain-types/contracts/UniswapV2Pair";
...
describe("UniswapV2Pair", function () {
  ...
  beforeEach(async function () {
    ...
    token0 = (await ERC20.deploy(TOTAL_SUPPLY)) as unknown as ERC20;
    await token0.waitForDeployment();

    token1 = (await ERC20.deploy(TOTAL_SUPPLY)) as unknown as ERC20;
    ...
    factory = (await UniswapV2Factory.deploy(wallet.address)) as unknown as UniswapV2Factory;
    ...
    pair = (await ethers.getContractAt("UniswapV2Pair", create2Address)) as unknown as UniswapV2Pair;
